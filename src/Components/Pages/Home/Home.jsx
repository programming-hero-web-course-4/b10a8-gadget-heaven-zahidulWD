...
const Home = () => {
    ...
    return (
        <div>
            <div className='max-w-[1600px] px-2 md:px-[30px] pt-28 -mt-40 relative bg-white'>
                <div className='bg-[#9538E2] border-[7px] border-[#F6F6F6] text-center rounded-3xl md:rounded-[32px] mb-[390px]'>
            ...
            <div className='gadgets-tabs-area'>
                <div className='container px-4 sm:px-10 md:px-14 lg:px-24 xl:px-0 xl:max-w-[1100px] 2xl:max-w-[1280px] mx-auto'>
                    ...
                    <div className='grid grid-cols-[3fr_9fr] gap-6'>
                        <div className='bg-white p-6 border border-[#09080F1A] rounded-2xl'>
                            {
                                tabs.map(tab => <Tabs key={tab.id} tab={tab}></Tabs>)
                            }
                        </div>
                        <Outlet></Outlet>
                    </div>
